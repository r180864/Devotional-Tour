<div class="col-xl-4 col-lg-6 col-sm-12 mt-5">
	<div class="card shadow m-auto bg-light" style="width: 23rem;">
		<div class="inner">
			<img class="card-image-top" src="images/Ayodhya1.jpg" alt="IMAGE" height="250">
		</div>
		<div class="card-body text-center">
			<h5 class="card-title">Ayodhya</h5>
			<p class="card-text">This is Ayoodhya, The Place Of Ram</p>
			<a href=".ayodhya" class="btn btn-primary">VISIT</a>
		</div>
	</div>
</div>
...
<div class="col-xl-4 col-lg-6 col-sm-12 mt-5">
	<div class="card m-auto shadow bg-light" style="width: 23rem;">
		<div class="inner">
...
<div class="col-xl-4 col-lg-6 col-sm-12 mt-5">
	<div class="card m-auto shadow bg-light" style="width: 23rem;">
		<div class="inner">
			<img class="card-image-top" src="images/Udipi1.jpg" alt="IMAGE" height="250">
		</div>
		<div class="card-body">
